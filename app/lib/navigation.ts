...
export const navigationConfig: NavSection[] = [
  ...
  },
  {
    ...
    subtabs: [
      { id: 'todos', nombre: 'Todos', ruta: '/pagos' },
  ...
  },
  {
    ...
    subtabs: [
      { id: 'tickets', nombre: 'Tickets', ruta: '/mantenimiento' },
      { id: 'inventario', nombre: 'Inventario', ruta: '/mantenimiento/inventario' },
    ],
  },
  {
    id: 'reportes',
    ...
    subtabs: [
      { id: 'ingresos', nombre: 'Ingresos', ruta: '/reportes' },
